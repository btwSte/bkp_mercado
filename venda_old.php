...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script>
      /*
      Exemplo para criar a tecla de atalho
      */
    ...
    <body onload="foco_ean(), moveRelogio();" bgcolor="#333333" bgcolor="#ffffff">
                ...
                <form action="" method="post" id="add" name="add" >
                  <table width="761" border="0">
                    ...
                    <tr>
                      ...
                      <td>
                        &nbsp; &nbsp;
                        <input name="qtd_prod" type="text" id="qtd_prod" style="font-size: 17px; border:solid #000 1px; color: #666; border-radius: 2px; padding-left: 2px; outline:none;" onblur="KW_calcForm('total do item',100,2,'(','#valor_prod','*','#qtd_prod',')')" onkeydown="return handleEnter(this, event)" onkeyup="SubstituiVirgulaPorPonto(this)" value="1" size="8"  />
                      </td>
                      <td rowspan="4">
                        <p>&nbsp;</p>
                      </td>
                    ...
                    <tr>
                      ...
                      <td style="">
                        &nbsp; &nbsp;
                        <input name="total_prod" type="text" id="total_prod" onfocus="KW_calcForm('total_prod',100,2,'(','#valor_prod','*','#qtd_prod',')')" size="8" style=" font-size: 17px; border:solid #000 1px; border-radius: 2px; color: #666; padding-left: 2px; outline:none;"  value="<?php echo $row_chama_produto['valor']; ?>" />
                      </td>
                    </tr>
                    <tr>
